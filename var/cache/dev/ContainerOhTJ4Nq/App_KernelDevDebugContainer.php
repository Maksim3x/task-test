...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'operation_service' => 'getOperationServiceService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('3k20npGTam', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    /**
     * Gets the public 'operation_service' shared autowired service.
     *
     * @return \App\Services\Operation\OparationService
     */
    protected function getOperationServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Services/Operation/OperationService.php';

        return $this->services['operation_service'] = new \App\Services\Operation\OparationService();
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Y7ui9mYIH0', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
